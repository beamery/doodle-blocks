...
Blockly.Comment.prototype.createEditor_ = function() {
  ...
  */
  ...
  Blockly.bindEventWithChecks(textarea, 'mouseup', this, this.textareaFocus_);
  // Don't zoom with mousewheel.
  Blockly.bindEventWithChecks(textarea, 'wheel', this, function(e) {
    e.stopPropagation();
  });
  Blockly.bindEventWithChecks(textarea, 'change', this, function(/* e */) {
